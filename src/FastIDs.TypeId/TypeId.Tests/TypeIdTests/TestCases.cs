...
{
    public static TestCaseData[] NoPrefix =>
    [
        new("00000000000000000000000000", new Guid("00000000-0000-0000-0000-000000000000"), ""),
        new("00000000000000000000000001", new Guid("00000000-0000-0000-0000-000000000001"), ""),
        new("0000000000000000000000000a", new Guid("00000000-0000-0000-0000-00000000000a"), ""),
        new("00000000000000000000000010", new Guid("00000000-0000-0000-0000-000000000020"), ""),
        new("7zzzzzzzzzzzzzzzzzzzzzzzzz", new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), ""),
        new("0000000000000000000000000g", new Guid("00000000-0000-0000-0000-000000000010"), ""),
        new("00000000000000000000000010", new Guid("00000000-0000-0000-0000-000000000020"), ""),
        new("01h455vb4pex5vsknk084sn02q", new Guid("01890a5d-ac96-774b-bcce-b302099a8057"), ""),
    ];

    public static TestCaseData[] WithPrefix =>
    [
        new("zeroid_00000000000000000000000000", new Guid("00000000-0000-0000-0000-000000000000"), "zeroid"),
        new("maxid_7zzzzzzzzzzzzzzzzzzzzzzzzz", new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), "maxid"),
        new("prefix_0123456789abcdefghjkmnpqrs", new Guid("0110c853-1d09-52d8-d73e-1194e95b5f19"), "prefix"),
        new("type_01h455vb4pex5vsknk084sn02q", new Guid("01890a5d-ac96-774b-bcce-b302099a8057"), "type"),
        new($"{new string('a', 63)}_0123456789abcdefghjkmnpqrs", new Guid("0110c853-1d09-52d8-d73e-1194e95b5f19"), new string('a', 63)),
        new("pre_fix_00000000000000000000000000", new Guid("00000000-0000-0000-0000-000000000000"), "pre_fix"),
    ];

    public static TestCaseData[] ValidIds => WithPrefix.Concat(NoPrefix).ToArray();

    public static TestCaseData[] InvalidIds =>
    [
        ...
        new("_prefix_00000000000000000000000000") { TestName = "The prefix can't start with an underscore" },
        new("prefix__00000000000000000000000000") { TestName = "The prefix can't end with an underscore" },
    ];
}